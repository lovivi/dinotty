...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'agent.title': 'Agent',
    'agent.run': 'Run',
    'agent.noSelection': 'Select a session',
    'agent.noSessions': 'No active terminal sessions',
    'agent.noResults': 'Run a command to see results',
    'agent.commandPlaceholder': 'Type a command and press Enter…',
    'agent.copy': 'Copy Output',
    ...
    'settings.restore.title': 'Worksite Restore',
    'settings.restore.enabled': 'Restore tabs after restart',
    'settings.restore.enabledHint': 'Automatically recreate tabs, panes, and working directories after server restart',
    'settings.restore.persistOutputTails': 'Save output tails',
    'settings.restore.persistOutputTailsHint': 'Keep a snippet of recent terminal output for context recall (more disk use)',
    'settings.restore.clearHistory': 'Clear restore history',
    'settings.restore.clearHistoryConfirm': 'Clear all saved restore history? This cannot be undone.',
    ...
    'project.menuTitle': 'Project Group',
    'project.noProject': 'No Project',
    'project.create': 'Create Project...',
    'project.moveCurrentTabHere': 'Move Current Tab Here',
    'project.renameTitle': 'Rename project',
    'project.moveToTitle': 'Move current tab here',
    'project.promptCreate': 'Project name',
    'project.promptRename': 'Rename project',
    'project.confirmDelete': 'Delete project "{name}"?',
    'project.confirmDeleteWithTabs':
    ...
    'remote.desktopOnlyHint': 'Remote access is available in the desktop app.',
    'remote.helpTitle': 'Remote Access Setup',
    'remote.helpStep1Title': 'On the server (VPS)',
    'remote.helpStep1Desc': 'SSH into your VPS and run this one-liner. It installs the relay, starts it, and prints a URL + password.',
    'remote.helpStep1Hint': 'Replace "mypassword123" with your own password.',
    'remote.helpStep2Title': 'On your phone',
    'remote.helpStep2Desc': 'Install this APK to your Android phone:',
    'remote.helpStep3Title': 'On your desktop',
    'remote.helpStep3Desc': 'Enter the URL and password this app gave you, then click Connect. The desktop opens an outbound WebSocket to the relay — no extra commands needed.',
    'remote.helpQuickRef': 'Quick reference',
    'remote.helpColItem': 'What',
    'remote.helpColWhere': 'Where',
    'remote.helpRefServer': 'On the VPS (root / sudo)',
    'remote.helpRefApk': 'On your phone (sideload)',
    'remote.helpRefWindows': 'This app',
  },
  zh: {
    'app.settings': '设置',
    'app.preview': '网页预览',
    ...
    'agent.title': 'Agent',
    'agent.run': '执行',
    'agent.noSelection': '请选择一个会话',
    'agent.noSessions': '没有活跃的终端会话',
    'agent.noResults': '执行命令后将显示结果',
    'agent.commandPlaceholder': '输入命令，按 Enter 执行…',
    'agent.copy': '复制输出',
    ...
    'settings.restore.title': '工作现场恢复',
    'settings.restore.enabled': '重启后恢复标签页',
    'settings.restore.enabledHint': '服务器重启后自动重建标签页、窗格和工作目录',
    'settings.restore.persistOutputTails': '保存输出摘要',
    'settings.restore.persistOutputTailsHint': '保留近期终端输出片段以帮助回忆上下文（占用更多磁盘）',
    'settings.restore.clearHistory': '清除恢复历史',
    'settings.restore.clearHistoryConfirm': '确定清除所有已保存的恢复历史？此操作不可撤销。',
    ...
    'project.menuTitle': '项目分组',
    'project.noProject': '无项目',
    'project.create': '新建项目...',
    'project.moveCurrentTabHere': '将当前标签页移至此',
    'project.renameTitle': '重命名项目',
    'project.moveToTitle': '将当前标签页移至此项目',
    'project.promptCreate': '项目名称',
    'project.promptRename': '重命名项目',
    ...
    'remote.password': '密码',
    'remote.desktopId': '桌面 ID',
    'remote.connect': '连接',
    'remote.disconnect': '断开',
    'remote.connecting': '连接中…',
    'remote.statusConnected': '已连接',
    'remote.statusDisconnected': '未连接',
    'remote.statusConnecting': '连接中…',
    'remote.desktopOnlyHint': '远程访问仅在桌面端可用。',
    'remote.helpTitle': '远程访问设置',
    'remote.helpStep1Title': '在服务器（VPS）上',
    'remote.helpStep1Desc': 'SSH 到 VPS 后跑这一行。它会装好 relay 并启动，输出 URL + 密码。',
    'remote.helpStep1Hint': '把 "mypassword123" 换成你自己的密码。',
    'remote.helpStep2Title': '在手机上',
    'remote.helpStep2Desc': '把这个 APK 装到安卓手机：',
    'remote.helpStep3Title': '在桌面上',
    'remote.helpStep3Desc': '输入本 app 给的 URL 和密码后点 Connect。桌面端会自动开 outbound WS 到 relay — 不需要额外跑命令。',
    'remote.helpQuickRef': '快速参考',
    'remote.helpColItem': '物品',
    'remote.helpColWhere': '位置',
    'remote.helpRefServer': 'VPS（root / sudo）',
    'remote.helpRefApk': '手机（手动装）',
    'remote.helpRefWindows': '本 app',
  },
}
